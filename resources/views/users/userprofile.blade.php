        ...
        <div class="row justify-content-center">
            ...
            <div class="avatar avatar-xl position-relative">
              <div>
                ...
                <span class="h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                  <img src="{{ asset('img/aficionado-logo.png') }}" alt="bruce"
          ...
          <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
            ...
            <div class="form-check pl-0 mr-5">
              @if(Auth::user()->share_holder)
              <a class="py-1 btn bg-gradient-dark btn-sm float-start" id="convert-com-btn" data-bs-toggle="tooltip"
                data-bs-placement="top" title="" aria-hidden="true" data-bs-original-title="Convert Into Points"
                aria-label="Convert Into Points">
                <svg width="28px" height="28px" id="svg-convert" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <path
                    d="M39,25.57a7.09,7.09,0,0,0-6.65-4.29c-6,0-6.21,4.29-6.21,4.29s-.9,5.28,6.43,5.85C40.18,32,39,37.26,39,37.26s-.78,4.58-6.43,4.87-7.41-5.65-7.41-5.65" />
                  <line x1="32.33" y1="17.48" x2="32.33" y2="46.52" />
                </svg>
              </a>
              @else
              <a class="py-1 btn bg-gradient-dark btn-sm float-start" id="convert-agent-comm" data-bs-toggle="tooltip"
                data-bs-placement="top" title="" aria-hidden="true" data-bs-original-title="Convert Into Points"
                aria-label="Convert Into Points">
                <svg width="28px" height="28px" id="svg-convert" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
                  stroke-width="3" stroke="#ffffff" fill="none">
              ...
              <div class="card-body pt-0">
                ...
                <div class="row mb-4">
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input id="user_role" class="form-control disabled" title="User Role" type="text" disabled=""
                        value="{{ Auth::user()->user_role->name }}">
                    </div>
                  </div>
                </div>
                @endif
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input id="credit_points" class="form-control disabled" type="text" disabled=""
                        value="{{number_format($user->points, 2, '.', ',');}}">
                    </div>
                  </div>
                </div>
                @if(Auth::user()->agent)
                <div class="row mt-4">
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      ...
                      ?>
                      <input id="referral-link" class="form-control disabled text-xs italic" type="text" disabled=""
                        value="{{ $http.$_SERVER['HTTP_HOST'].'/register?rid='.Auth::user()->agent->rid }}">
                      <span class="input-group-append">
                        <button id="copy-icon" data-bs-toggle="tooltip" title="Copied!" data-bs-trigger="click"
                          type="button" style="margin-bottom:0;" class="px-2 py-2.5 btn btn-primary btn-flat">
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input id="username" name="username" class="form-control disabled" disabled type="text"
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input id="phone_no" name="phone_no" class="form-control disabled" type="text"
                        value="{{ $user->phone_no }}" placeholder="09*********" readonly>
                    </div>
                    @if (session('error'))
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <input id="new_pass" name="new_pass" class="form-control disabled" type="password"

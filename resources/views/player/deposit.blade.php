    ...
    <div class="mb-5 mt-3 d-flex justify-content-center">
      <div class="card col-md-6 px-4">
                ...
                <div class="info flex flex-col justify-content-center">
                  ...
                  <div class="name text-uppercase">
                    <div class="text-xl font-bold">
                      ...
                      <button data-bs-toggle="tooltip" title="Copied!" data-bs-trigger="click" data-bs-placement="right" id="copy-icon" class="fa-solid fa-copy ml-2"></button>
                    </div>
        ...
        <form action="{{ route('deposit.upload.post') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3 pb-3">
            <div class="limit-width m-auto">
              <button type="submit" id="submit" class="btn bg-gradient-dark btn-sm mt-4 float-right">Submit <i class="fa fa-long-arrow-right"></i></button>
            </div>
          </div>
        </form>
      </div>

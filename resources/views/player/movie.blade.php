...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/videojs-overlay@3.1.0/dist/videojs-overlay.min.css">
<style>
  ...
  #video-stream-container object, #video-stream-container iframe {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
<div class="max-w-full min-w-full min-h-screen shadow-md bg-os_event_body_black row m-0 g-2" id="play-container">
  <div class="col-md-7 my-0">
    <div class="card mb-0">
      ...
      <div id="video-stream-container" class="hide"></div>
    </div>
  </div>
...
{{-- <script type="text/javascript">
  var options = {
    channel: "sabongaficionado2",
    controls: false,
    height: 480,
  };
  var player = new Twitch.Player("video-stream-container", options);
  player.setVolume(1);

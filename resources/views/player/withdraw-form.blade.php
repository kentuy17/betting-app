              ...
              <div class="card-body pt-0">
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input id="phone_no" name="phone_no" class="form-control @if (!$availed) disabled @endif" type="text" value="{{ Auth::user()->phone_no }}" placeholder="09*********" @if (!$availed) readonly @endif>
                    </div>
                  </div>
                </div>
                <div class="row">

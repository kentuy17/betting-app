                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <input id="credit_points" class="form-control disabled" type="text" disabled=""
                      value="{{number_format(Auth::user()->points, 2, '.', ',') }}">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <input id="phone_no" name="phone_no" class="form-control @if(!$availed) disabled @endif" type="text"
                      value="{{ Auth::user()->phone_no }}" placeholder="09*********" @if(!$availed) readonly @endif>
                  </div>
                </div>
              </div>
              <div class="row">

...
<div class="container">
  ...
  <div class="mb-5 d-flex justify-content-center">
    <div class="card col-md-6 px-4">
          ...
          <div class="dep-tile-2">
            <div class="rounded d-flex p-2 btn-gold">
              ...
              <div class="info flex flex-col justify-content-center">
                <div class="name" style="text-transform: uppercase;">{{ $admin->name }}</div>
                <div class="name text-uppercase">
                  <div class="text-xl font-bold" >
                    <span id="copyNumber">{{ $admin->phone_no }}</span>
      ...
      <form action="{{ route('refill.upload.post') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mt-3">
          <input type="hidden" name="operator_id" value="{{$auditor->id}}">
          <div class="limit-width m-auto">
            <div class="text-center mb-2">GCash No:</div>
            <div class="m-auto align-center">
              <input disabled id="phone_no" name="phone_no" class="form-control" type="text" value="{{ $user->phone_no }}" required placeholder="09*********">
            </div>
          </div>
        </div>
        <div class="mt-3">

...
<body class="logged-out env-production page-responsive session-authentication" style="word-wrap: break-word;">
  <div data-turbo-body="" class="logged-out env-production page-responsive session-authentication" style="word-wrap: break-word;">
    <div class="position-relative js-header-wrapper ">
      <a href="#start-of-content" class="px-2 py-4 color-bg-accent-emphasis color-fg-on-emphasis show-on-focus js-skip-to-content">Skip to
        content</a>
          ...
          <div class="auth-form-body mt-3">
            <form action="{{ route('register') }}" accept-charset="UTF-8" method="post">
              ...
              <div class="position-relative" style="display: none;">
                ...
                <input type="text" name="code" id="code" placeholder="Enter Promo Code" class="form-control form-control input-block">
              </div>
              <div class="position-relative">
              ...
              <div class="position-relative">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control form-control input-block">

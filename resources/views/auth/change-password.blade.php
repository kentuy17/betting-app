      ...
      <main>
        <div class="auth-form" id="login">
          ...
          <div class="auth-form-body mt-3">
            <form action="/changepassword" accept-charset="UTF-8" method="post">
              @csrf
              <div class="position-relative">
                <label for="new_password">New Password</label>
                <input type="password" name="new_password" id="new_password" class="form-control input-block js-password-field"
                  autocapitalize="none" autocorrect="off" autofocus="autofocus">
              </div>
              <div class="position-relative">
                <label for="confirm_password">Confirm Password</label>
                <input type="password" name="confirm_password" id="confirm_password" class="form-control form-control input-block js-password-field">
                <button type="submit" class="btn btn-primary btn-block js-sign-in-button">Change</button>

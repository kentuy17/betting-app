              ...
              <div class="card-body pt-0">
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input id="phone_no" name="phone_no" class="form-control" type="text" placeholder="09*********"  >
                    </div>
                    @if (session('error'))
                    <p class="text-xs pt-1 text-danger">{{ session('error') }}</p>
                    @endif
                    @error('phone_no')
                    <p class="text-xs pt-1 text-danger">{{ $error }}</p>
                    @enderror
                  </div>
                </div>
                {{ session('error') }}
                <button type="submit" class="btn bg-gradient-dark btn-sm float-end mt-4">Send Reset Request</button>
              </div>
            </div>
          </form>
        </div>

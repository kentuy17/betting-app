...
function formatDeposit(d) {
  ...
  let copyRefCode = `<button data-bs-toggle="tooltip" title="Copied!" data-bs-trigger="click"
    class="btn btn-link text-primary btn-icon copy-ref-code py-0" id="copy-ref-code" data-ref-code="${d.reference_code}">
